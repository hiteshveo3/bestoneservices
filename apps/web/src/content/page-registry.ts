...
export const pageRegistry = pageTargetSchema.array().parse([
  ...
  { path: "/pest-control-services/squirrel-control/", pageType: "pest", primaryKeyword: "squirrel control", secondaryKeywords: [], searchIntent: "commercial", status: "published", indexable: true, changeFrequency: "monthly", priority: 0.8 },
  { path: "/pest-control-services/spider-treatment/", pageType: "pest", primaryKeyword: "spider treatment", secondaryKeywords: [], searchIntent: "commercial", status: "published", indexable: true, changeFrequency: "monthly", priority: 0.7 },
  { path: "/pest-control-services/silverfish-treatment/", pageType: "pest", primaryKeyword: "silverfish treatment", secondaryKeywords: [], searchIntent: "commercial", status: "published", indexable: true, changeFrequency: "monthly", priority: 0.7 },
  { path: "/pest-control-services/moth-treatment/", pageType: "pest", primaryKeyword: "moth treatment", secondaryKeywords: [], searchIntent: "commercial", status: "published", indexable: true, changeFrequency: "monthly", priority: 0.7 },
  { path: "/pest-control-services/carpet-beetles/", pageType: "pest", primaryKeyword: "carpet beetle treatment", secondaryKeywords: [], searchIntent: "commercial", status: "published", indexable: true, changeFrequency: "monthly", priority: 0.7 },
  { path: "/pest-control-services/woodworm-treatment/", pageType: "pest", primaryKeyword: "woodworm treatment", secondaryKeywords: [], searchIntent: "commercial", status: "published", indexable: true, changeFrequency: "monthly", priority: 0.7 },
  { path: "/pest-control-services/general-fogging/", pageType: "pest", primaryKeyword: "general fogging", secondaryKeywords: [], searchIntent: "commercial", status: "published", indexable: true, changeFrequency: "monthly", priority: 0.6 },
