...
export const pestControlContent = {
  ...
  pests: [
    ...
    ["Ant control", "Identify the rooms, entrances or outdoor areas where activity occurs."],
    ["Flea treatment", "Describe bites, pet areas, carpets and the rooms affected."],
    ["Wasp control", "Tell us where wasps are active and whether a nest is visible."],
